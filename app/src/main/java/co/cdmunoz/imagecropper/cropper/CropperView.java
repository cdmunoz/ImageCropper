...
public class CropperView extends android.support.v7.widget.AppCompatImageView
    implements ICropperView {
  ...
  @Override public CropperViewAttacher.OnPhotoTapListener getOnPhotoTapListener() {
    return mAttacher.getOnPhotoTapListener();
  }

  @Override public void setOnPhotoTapListener(CropperViewAttacher.OnPhotoTapListener listener) {
    mAttacher.setOnPhotoTapListener(listener);
  }

  @Override public CropperViewAttacher.OnViewTapListener getOnViewTapListener() {
    return mAttacher.getOnViewTapListener();
  }

  @Override public void setOnViewTapListener(CropperViewAttacher.OnViewTapListener listener) {
