...
import co.cdmunoz.imagecropper.R;
import co.cdmunoz.imagecropper.cropper.CropperViewAttacher;
import co.cdmunoz.imagecropper.cropper.utils.PaintUtil;
...
public class CropOverlayView extends View implements CropperViewAttacher.IGetImageBounds {
  ...
  public CropOverlayView(Context context, AttributeSet attrs) {
    ...
    try {
      ...
      mMarginTop =
          ta.getDimensionPixelSize(R.styleable.CropOverlayView_marginTop, DEFAULT_MARGINTOP);
      mMarginSide =
          ta.getDimensionPixelSize(R.styleable.CropOverlayView_marginSide, DEFAULT_MARGINSIDE);
      mBorderPaintColor =
          ta.getColor(R.styleable.CropOverlayView_borderColor, DEFAULT_BOARDER_COLOR);
      mBackgroundColor =
          ta.getColor(R.styleable.CropOverlayView_overlayColor, DEFAULT_BACKGROUND_COLOR);
      mCornerRadius =
          ta.getDimension(R.styleable.CropOverlayView_cornerRadius, DEFAULT_CORNER_RADIUS);
    } finally {
      ta.recycle();
    }
  ...
  @Override protected void onDraw(Canvas canvas) {
    ...
    if (mDrawCircle) {
      ...
      final float radius = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, mCornerRadius,
  ...
  private void init(Context context) {
    ...
    rectF =
        new RectF(Edge.LEFT.getCoordinate(), Edge.TOP.getCoordinate(), Edge.RIGHT.getCoordinate(),
